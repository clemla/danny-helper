...
const TitleLines = ["# 🛡️ Moderation", "-# Message cleanup tools."]
...
const Lines = [
	"## `/delto`",
	"Deletes every message sent after a given message, up to 100 at once.",
	"- `id` - the message id to stop at (delete everything newer than it)",
	"-# Requires Manage Messages. Guild channels only.",
]
